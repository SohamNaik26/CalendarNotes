...
// MARK: - Modal Overlay Wrapper (Centered Card)

struct FilterModalOverlay: View {
    @ObservedObject var viewModel: FilterViewModel
    ...
    var body: some View {
        ZStack {
            ...
            Color.black.opacity(0.45)
                .ignoresSafeArea()
                .onTapGesture { viewModel.showFilterPanel = false }
            ...
            VStack(spacing: 0) {
                ...
                HStack {
                    ...
                    .foregroundColor(viewModel.hasActiveFilters ? .cnStatusError : .secondary)
                    ...
                    Text("Filters")
                        .font(.headline)
                    Spacer()
                    Button(action: { viewModel.showFilterPanel = false }) {
            ...
            .frame(maxWidth: 620, maxHeight: 700)
