...
class CloudKitManager: ObservableObject {
    ...
    private var syncMonitoringObserver: NSObjectProtocol?
    
    func startSyncMonitoring() {
        // Monitor Core Data remote change notifications
        syncMonitoringObserver = NotificationCenter.default.addObserver(
    ...
    deinit {
        if let observer = syncMonitoringObserver {
