...
class EventKitManager: ObservableObject {
    ...
    private var syncStatistics = EventKitSyncStatistics()
    ...
    func performFullSync() async throws -> EventKitSyncStatistics {
        ...
        syncStatistics = EventKitSyncStatistics()
    ...
    func getSyncStatistics() -> EventKitSyncStatistics {
        return syncStatistics
    }
